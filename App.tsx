...
const App: React.FC = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 overflow-hidden font-sans transition-colors duration-300">
      {/* Sticky Header */}
          ...
          <div className="flex w-full items-center px-6">
            ...
            <div className="w-[30%] border-l border-gray-200 dark:border-gray-800 ml-8 pl-8 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button onClick={() => setIsDarkMode(!isDarkMode)} className="p-2 text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 rounded-lg transition-colors" title="Toggle Dark Mode">
                  {isDarkMode ? (
      ...
      <main className="flex-1 flex overflow-hidden relative">
        {activeItem ? (
          <>
            <div className="flex-1 flex flex-col overflow-hidden bg-white dark:bg-gray-950 transition-colors">
              <TranscriptViewer 
          ...
          <div className="flex-1 overflow-y-auto p-8 custom-scrollbar bg-gray-50 dark:bg-gray-950 transition-colors">
